...
public void activateBackDataSystem() {
  int potValueInstallation2 = getPotValue(potInstallation2);
  float mappedIncomingData = map(incomingData, 0.0008, 0.15, 15, 500);
  
  if(potValueInstallation2 > mappedIncomingData) {
